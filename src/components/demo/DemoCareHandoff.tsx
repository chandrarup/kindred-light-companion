...
const T = {
  ...
  fullItems: {
    en: [
      ...
      "Trigger fingerprint — patterns COMPANION learned",
    ...
    es: [
      ...
      "Huella de desencadenantes — patrones que COMPANION aprendió",
  ...
  doneSub: {
    en: "Everything COMPANION learned about her goes with her.",
    es: "Todo lo que COMPANION aprendió sobre ella va con ella.",
  },
